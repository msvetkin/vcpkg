...
function(vcpkg_find_acquire_program program)
    ...
    elseif(program STREQUAL "PATCHELF")
        ...
        set(program_version 0.14.3)
        set(supported_on_unix ON)
        if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
            set(download_filename "${program_version}/${program_name}-${program_version}-x86_64.tar.gz")
            set(download_urls "https://github.com/NixOS/patchelf/releases/download/${program_version}/${program_name}-${program_version}-x86_64.tar.gz")
            set(tool_subdirectory "${program_version}-linux")
            set(paths_to_search "${DOWNLOADS}/tools/patchelf/${program_version}-linux/bin")
            set(download_sha512 0dfb4cbc6596a27405b031fc9dc87d9dc32c3f9599f9cfd89cf345a727de4011c40c8a07c5ef512d30813f7c2ea2f4c0b46a6b0f22c3a45d94856e9fb8c84368)
        endif()
        set(version_command --version)
    else()
